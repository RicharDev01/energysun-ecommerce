...
<page style="font-size: 14px">
    <span style="font-weight: bold; font-size: 18pt; color: #FF0000; font-family: Times">Veamos que hace este ejemplo<br></span>
    <br>
    Retours à la ligne autorisés :
    <br>
    Barre horizontale &lt;hr&gt;<hr style="height: 4mm; background: #AA5500; border: solid 1mm #0055AA">
    Exemple de lien : <a href="#" >le site Html2Pdf</a><br>
    <br>
    Image : <img src="<?= \App\Config\Parameters::BASE_URL ?>/resources/images/kit-autoconsumo-trifasico-kostal-4200w-22000whdia_thumb_main.jpg" alt=""> <br>
    <br>
